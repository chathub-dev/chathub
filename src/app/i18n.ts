...
const resources = {
  ...
  'zh-TW': {
    translation: {
      ...
      'More bots in All-In-One mode': '在All-In-One模式下使用更多chatbot（三合一、四合一）',
      'Chat history full-text search': '全文搜索聊天記錄',
      'Customize theme': '自定義主題',
      'More features in the future': '享受未來所有功能更新',
      ...
      'Three in one': '三合一',
      'Four in one': '四合一',
      'Activate up to 5 devices': '最多可激活5台設備',
      Deactivate: '反激活',
      'Get premium license': '購買會員',
      'Theme Settings': '主題設置',
      'Theme Mode': '主題模式',
      'Theme Color': '主題色',
      ...
      'You have opened ChatHub {{openTimes}} times, consider unlock all features?':
        '哇！你已經打開ChatHub {{openTimes}}次了，是否要解鎖全部功能呢？🥺',
      ...
      'Upgrade to premium to chat with more than two bots or send images': '升級會員，同時和兩個以上的機器人聊天',
      Upgrade: '升級',
      'This usually mean you need to add a payment method to your OpenAI account, checkout: ':
        '這通常意味着您需要在OpenAI賬戶中添加付款方式，請查看：',
