...
const resources = {
  ...
  in: {
    translation: {
      ...
      'Cloud syncing data': 'Sinkronisasi data cloud',
      'More bots in All-In-One mode': 'Lebih banyak bot dalam mode All-In-One',
      'Chat history full-text search': 'Pencarian teks lengkap pada riwayat percakapan',
      'Customize theme': 'Sesuaikan tema',
      'More in the future': 'Lebih banyak fitur di masa depan',
      'Enjoy ChatHub? Give us a 5-star rating!': 'Menikmati ChatHub? Berikan rating 5 bintang!',
      ...
      'Follow Arc browser theme': 'Ikuti tema peramban Arc',
